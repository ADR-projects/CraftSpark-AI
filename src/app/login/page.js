...
export default function Login() {
  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center bg-amber-50 p-4">
      <div className="bg-white border-8 border-black p-8 shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] w-full max-w-md">
        <h2 className="text-4xl font-black mb-6 text-center">Log In</h2>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <input 
            ...
            className="p-3 border-4 border-black font-bold outline-none focus:bg-cyan-100 transition-colors"
            value={password}
